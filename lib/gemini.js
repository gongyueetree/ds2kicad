...
export function buildPrompt(need, hints = {}) {
  ...
  if (need.packages) {
    schema.push(`"packages": [ { "name": "e.g. SOIC-8", "tiCode": "vendor package code e.g. D", "type": "SOIC / TSSOP / PDIP ...", "drawingId": "vendor drawing number e.g. D0008A or empty", "pinsetId": "default", "pinCount": 8, "pitch": 1.27, "bodyLength": 4.9, "bodyWidth": 3.9, "height": 1.75, "leadSpan": 6.0, "leadLength": 1.0, "leadWidth": 0.41, "epLength": null, "epWidth": null, "landPattern": { "padW": 0.6, "padL": 1.55, "rowSpan": 5.4, "holeDia": null, "sourcePage": 63 } , "orderableParts": ["LM358D", "LM358DR"], "sourcePages": [62, 63], "notes": [] } ],
  "recommendedPackageIndex": 0`);
